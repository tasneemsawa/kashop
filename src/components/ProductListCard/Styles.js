export const Styles = {
  card: {display: 'flex', borderRadius: '12px', cursor: 'pointer',position: 'relative', boxShadow: '0px 1px 3px rgba(3, 0, 71, 0.09)', '&:hover': { boxShadow: '0px 8px 20px rgba(0,0,0,0.1)' } },
