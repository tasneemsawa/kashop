        ...
        <Grid container spacing={2}>
          ...
          <Grid size={{ xs: 12, md: 4 }} >
            <Stack spacing={4}>
              ...
              <Typography sx={{ color: '#aeb4be', marginBottom: "4px", maxWidth: '300px', fontSize: "14px" }}>
              ...
              <Stack direction="row" spacing={2}>
                <Box component="img" src={googlePlay} sx={{ width: 140, cursor: 'pointer' }} />
                <Box component="img" src={appStore} sx={{ width: 140, cursor: 'pointer' }} />
              </Stack>
            </Stack>
          </Grid>
          ...
          <Grid size={{ xs: 12, md: 3 }} >
            ...
            <Stack direction="row" spacing={1}>
              ...
              <IconButton sx={Styles.socialIcon} size="small"><TwitterIcon fontSize="8px" /></IconButton>
              <IconButton sx={Styles.socialIcon} size="small"><YouTubeIcon fontSize="8px" /></IconButton>
              <IconButton sx={Styles.socialIcon} size="small"><GoogleIcon fontSize="8px" /></IconButton>
              <IconButton sx={Styles.socialIcon} size="small" ><InstagramIcon fontSize="8px" /></IconButton>
            </Stack>
          </Grid>
